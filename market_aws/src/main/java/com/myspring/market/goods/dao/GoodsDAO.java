...
public class GoodsDAO {
	...
	public List<GoodsVO> searchGoodsByNew(Map<String, Object> keywordMap) throws DataAccessException {
		List<GoodsVO> searchGoodsList = sqlSession.selectList("mapper.goods.searchGoodsByNew", keywordMap);
		return searchGoodsList;
	}
	
	public List<GoodsVO> searchGoodsByLow(Map<String, Object> keywordMap) throws DataAccessException {
		List<GoodsVO> searchGoodsList = sqlSession.selectList("mapper.goods.searchGoodsByLow", keywordMap);
		return searchGoodsList;
	}
	
	public List<GoodsVO> searchGoodsByHigh(Map<String, Object> keywordMap) throws DataAccessException {
		List<GoodsVO> searchGoodsList = sqlSession.selectList("mapper.goods.searchGoodsByHigh", keywordMap);
		return searchGoodsList;
	}
	
	public int selectSearchGoodsSize(String keyword) throws DataAccessException {
		int size = sqlSession.selectOne("mapper.goods.selectSearchGoodsSize", keyword);
		return size;
	}
